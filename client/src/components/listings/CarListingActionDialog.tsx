...
export const CarListingActionDialog = ({
  ...
  // Check if the current user has permission for the action
  const hasActionPermission = () => {
      ...
      switch (actionType) {
          ...
          case "sold":
              // Only owners can mark as sold, and only if they have the permission
               return listing.user_id === user.id && 
                     hasPermission(roleName, Permission.MANAGE_ALL_LISTINGS) || hasPermission(roleName, Permission.MANAGE_OWN_LISTINGS);
          case "delete":
  ...
  // Only render the dialog if the user has permission
