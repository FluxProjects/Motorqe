...
export default function GarageNavigation() {
  ...
  const links = [
    { href: "/garage-dashboard", label: t("admin.dashboard") },
    { href: "/garage-dashboard/servicelistings", label: t("admin.manageServiceListings") },
    { href: "/garage-dashboard/servicebookings", label: t("admin.manageServiceBookings") },
    { href: "/garage-dashboard/messaging", label: t("admin.manageMessages") },
    { href: "/garage-dashboard/profile", label: t("admin.profile") },
  ];
