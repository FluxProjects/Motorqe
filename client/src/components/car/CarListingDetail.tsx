...
export function CarListingDetail ({ vehicleDescription, vehicleDescriptionAr }: TabNavigationProps) {
  const [activeTab, setActiveTab] = useState("car-details");

  const tabs = [
    { id: "car-details", label: "Car Details", active: true },
    { id: "inspection-report", label: "Inspection Report", active: false },
    { id: "spare-parts", label: "Spare Parts", active: false },
    { id: "tyres", label: "Tyres", active: false },
  ];
      ...
      <div className="bg-white rounded-lg p-4 shadow-sm border">
        ...
        {activeTab === "spare-parts" && (
          <div>
            ...
            <div className="text-gray-700">
              <p className="mb-4">
                Available spare parts and accessories for this vehicle:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-600">
        ...
        {activeTab === "tyres" && (
          <div>
            ...
            <div className="text-gray-700">
              <p className="mb-4">
                Tyre information and recommendations:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-600">
