                          ...
                          <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-200">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="flex justify-between items-center">
                                    <span className="text-sm">
                                      {t("seller.favoriteRate")}
                                    </span>
                                    <span className="font-medium">
                                      {stats.favoriteRate || 0}%
                                    </span>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="bg-neutral-50 p-4 rounded-lg border border-neutral-200">
                              <h3 className="text-sm font-medium text-neutral-600 mb-4">
                                {t("seller.topPerformingListings")}
                              </h3>
                              {stats.topListings &&
                              stats.topListings.length > 0 ? (
                                <div className="space-y-3">
                                  {stats.topListings.map((listing: any) => (
                                    <div
                                      key={listing.id}
                                      className="flex justify-between items-center p-2 bg-white rounded border border-neutral-100"
                                    >
                                      <div className="flex items-center">
                                        {listing.images &&
                                          listing.images.length > 0 && (
