...
export default function CarListingConfirmation() {
  ...
  const createdAt = new Date(listing.created_at).toLocaleString("en-US", {
    year: "numeric",
    month: "long",
    day: "numeric",
    hour: "2-digit",
    ...
    <div className="bg-white min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h3 className="text-3xl font-bold text-gray-900">Car Listing</h3>
          <p className="text-neutral-500 text-center">
            Place your car ad in seconds with just few clicks
          </p>
        </div>
        {/* Success Message */}
        <div className="text-center mb-8">
          ...
          <div className="bg-white p-6 border-b border-gray-200">
            <div>
              <h2 className="text-xl font-bold text-blue-700 mb-1">
                {listing?.currentPackage?.package_name}
              </h2>
            ...
            <div className="border-2 border-gray-400 rounded-md overflow-hidden">
              ...
              <div className="bg-white p-4 space-y-4">
                <div className="grid grid-cols-[200px_1fr] gap-y-2 items-start">
                  ...
                  <div className="text-neutral-800 font-medium">
                    {listing?.currentPackage?.package_price}
                  </div>
              ...
              <div className="bg-blue-900 text-white p-4 text-center">
                <div className="text-xl justify-end items-end text-right font-bold">
                  Total Price: {listing?.currentPackage?.package_price}
                </div>
              </div>
            </div>
          </div>
