...
import { AlertTriangle, Save, Settings2, Info, RefreshCw, Loader2, CheckCircle2 } from 'lucide-react';
...
const ManageSettings = () => {
  ...
  const [generalSettings, setGeneralSettings] = useState({
    siteName: 'CarMarket',
    siteDescription: 'Your trusted marketplace for buying and selling cars',
    contactEmail: 'support@carmarket.com',
  ...
  const [emailSettings, setEmailSettings] = useState({
    ...
    newListingTemplate: 'Your listing "{{title}}" has been published successfully.',
    newMessageTemplate: 'You have received a new message from {{sender}} regarding "{{listing}}"',
  });
  ...
  const settingsQuery = useQuery({
    ...
    onError: (error) => {
      toast({
        ...
        description: error instanceof Error ? error.message : t('admin.settingsFetchFailed'),
        variant: 'destructive',
      });
    }
  });
                ...
                <div className="max-w-7xl mx-auto">
                  ...
                  <div className="flex justify-between items-center mb-8">
                    <div>
                      ...
                      <p className="text-slate-400 mt-1">{t('admin.siteSettingsDesc')}</p>
                    </div>
                    <div>
                      <Button 
                        variant="outline" 
                        ...
                        <Card className="bg-slate-800 border-slate-700">
                          <CardHeader>
                            <div className="flex items-center">
                              ...
                              <CardTitle className="text-white">{t('admin.generalSettings')}</CardTitle>
                            </div>
                          ...
                          <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <div className="space-y-2">
                                <Label htmlFor="maxListingsPerUser" className="text-slate-300">
                                ...
                                <Input
                                  ...
                                  onChange={(e) => setGeneralSettings({...generalSettings, maxListingsPerUser: parseInt(e.target.value)})}
                                  className="bg-slate-700 border-slate-600 text-white"
                                />
                              </div>
                              
                              <div className="space-y-2">
                                <Label htmlFor="maxImagesPerListing" className="text-slate-300">
                                ...
                                <Input
                                  ...
                                  onChange={(e) => setGeneralSettings({...generalSettings, maxImagesPerListing: parseInt(e.target.value)})}
                                  className="bg-slate-700 border-slate-600 text-white"
                                />
                              </div>
                            ...
                            <div className="pt-4 space-y-4">
                              <div className="flex items-center justify-between">
                                <div>
                                  <Label htmlFor="enableRegistration" className="text-slate-300">
                                    {t('admin.enableRegistration')}
                                  </Label>
                                  <p className="text-slate-400 text-sm">{t('admin.enableRegistrationDesc')}</p>
                                </div>
                                <Switch
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  <Label htmlFor="requireEmailVerification" className="text-slate-300">
                                    {t('admin.requireEmailVerification')}
                                  </Label>
                                  <p className="text-slate-400 text-sm">{t('admin.requireEmailVerificationDesc')}</p>
                                </div>
                                <Switch
                              ...
                              <div className="flex items-center justify-between">
                                <div>
                                  <Label htmlFor="allowUserRating" className="text-slate-300">
                                    {t('admin.allowUserRating')}
                                  </Label>
                                  <p className="text-slate-400 text-sm">{t('admin.allowUserRatingDesc')}</p>
                                </div>
                                <Switch
                                  id="allowUserRating"
                                  checked={generalSettings.allowUserRating}
                                  onCheckedChange={(checked) => setGeneralSettings({...generalSettings, allowUserRating: checked})}
                                />
                              </div>
                            </div>
                            ...
                            <Alert className="bg-blue-900/20 border border-blue-800 text-blue-200">
                              ...
                              <AlertTitle>{t('admin.logoAndFaviconSettings')}</AlertTitle>
                              <AlertDescription>
                          ...
                          <CardFooter className="border-t border-slate-700 bg-slate-800/50 px-6 py-4">
                            ...
                            >
                              {updateSettings.isPending && updateSettings.variables?.general ? (
                                <>
                      ...
                      <TabsContent value="email" className="py-4">
                        <Card className="bg-slate-800 border-slate-700">
                          <CardHeader>
                            <div className="flex items-center">
                              <Settings2 className="h-5 w-5 text-blue-400 mr-2" />
                              <CardTitle className="text-white">{t('admin.emailSettings')}</CardTitle>
                            </div>
                            <CardDescription className="text-slate-400">
                          ...
                          <CardContent className="space-y-6">
                            <Alert className="bg-amber-900/20 border border-amber-800 text-amber-200">
                              ...
                              <AlertTitle>{t('admin.configureEmailFirst')}</AlertTitle>
                              <AlertDescription>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div className="space-y-2">
                                <Label htmlFor="smtpServer" className="text-slate-300">
                                  {t('admin.smtpServer')}
                                </Label>
                                <Input
                                  id="smtpServer"
                            ...
                            <div className="pt-4">
                              <div className="flex items-center justify-between mb-4">
                                <div>
                                  <Label htmlFor="enableEmailNotifications" className="text-slate-300">
                                    {t('admin.enableEmailNotifications')}
                                  </Label>
                                  <p className="text-slate-400 text-sm">{t('admin.enableEmailNotificationsDesc')}</p>
                                </div>
                                <Switch
                            ...
                            <div className="space-y-4">
                              <h3 className="text-white font-medium">{t('admin.emailTemplates')}</h3>
                              
                              <div className="space-y-2">
                                <Label htmlFor="newListingTemplate" className="text-slate-300">
                                  {t('admin.newListingTemplate')}
                                </Label>
                                <Textarea
                                  id="newListingTemplate"
                                  value={emailSettings.newListingTemplate}
                                  onChange={(e) => setEmailSettings({...emailSettings, newListingTemplate: e.target.value})}
                                  className="bg-slate-700 border-slate-600 text-white h-20"
                                />
                                <p className="text-xs text-slate-400">
                                  {t('admin.availablePlaceholders')}: {'{{title}}, {{username}}, {{date}}'}
                                </p>
                              </div>
                              
                              <div className="space-y-2">
                                <Label htmlFor="newMessageTemplate" className="text-slate-300">
                                  {t('admin.newMessageTemplate')}
                                </Label>
                                <Textarea
                                  id="newMessageTemplate"
                                  value={emailSettings.newMessageTemplate}
                                  onChange={(e) => setEmailSettings({...emailSettings, newMessageTemplate: e.target.value})}
                                  className="bg-slate-700 border-slate-600 text-white h-20"
                                />
                                <p className="text-xs text-slate-400">
                                  {t('admin.availablePlaceholders')}: {'{{sender}}, {{listing}}, {{recipient}}, {{date}}'}
                                </p>
                              </div>
                            </div>
                          </CardContent>
                          <CardFooter className="border-t border-slate-700 bg-slate-800/50 px-6 py-4">
                            ...
                            <Button 
                              ...
                              disabled={updateSettings.isPending}
                            >
                              {updateSettings.isPending && updateSettings.variables?.email ? (
                                <>
                                  <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                                  {t('common.saving')}
                                </>
                      ...
                      <TabsContent value="integrations" className="py-4">
                        <Card className="bg-slate-800 border-slate-700">
                          <CardHeader>
                            <div className="flex items-center">
                              <Settings2 className="h-5 w-5 text-blue-400 mr-2" />
                              <CardTitle className="text-white">{t('admin.integrationSettings')}</CardTitle>
                            </div>
                            <CardDescription className="text-slate-400">
                          ...
                          <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              ...
                              <div className="space-y-4">
                                <div className="flex items-center">
                                  <h3 className="text-white font-medium">{t('admin.googleAnalytics')}</h3>
                                  <Switch
                                    id="enableGoogleAnalytics"
                                    checked={integrationSettings.enableGoogleAnalytics}
                                    onCheckedChange={(checked) => setIntegrationSettings({...integrationSettings, enableGoogleAnalytics: checked})}
                                    className="ml-auto"
                                  />
                                </div>
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Input
                                    ...
                                    className="bg-slate-700 border-slate-600 text-white"
                                    disabled={!integrationSettings.enableGoogleAnalytics}
                                  />
                                </div>
                              </div>
                              ...
                              <div className="space-y-4">
                                <div className="flex items-center">
                                  <h3 className="text-white font-medium">{t('admin.facebookPixel')}</h3>
                                  <Switch
                                    id="enableFacebookPixel"
                                    checked={integrationSettings.enableFacebookPixel}
                                    onCheckedChange={(checked) => setIntegrationSettings({...integrationSettings, enableFacebookPixel: checked})}
                                    className="ml-auto"
                                  />
                                </div>
                                
                                <div className="space-y-2">
                                  <Label htmlFor="facebookPixelId" className="text-slate-300">
                                  ...
                                  <Input
                                    ...
                                    className="bg-slate-700 border-slate-600 text-white"
                                    disabled={!integrationSettings.enableFacebookPixel}
                                  />
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-8">
                              ...
                              <div className="space-y-4">
                                <div className="flex items-center">
                                  <h3 className="text-white font-medium">{t('admin.googleMaps')}</h3>
                                  <Switch
                                    id="enableLocationMap"
                                    checked={integrationSettings.enableLocationMap}
                                    onCheckedChange={(checked) => setIntegrationSettings({...integrationSettings, enableLocationMap: checked})}
                                    className="ml-auto"
                                  />
                                </div>
                                
                                <div className="space-y-2">
                                  <Label htmlFor="googleMapsApiKey" className="text-slate-300">
                                  ...
                                  <Input
                                    ...
                                    className="bg-slate-700 border-slate-600 text-white"
                                    disabled={!integrationSettings.enableLocationMap}
                                  />
                                </div>
                              </div>
                              ...
                              <div className="space-y-4">
                                <div className="flex items-center">
                                  <h3 className="text-white font-medium">{t('admin.paymentGateway')}</h3>
                                  <Switch
                                    id="enablePayments"
                                    checked={integrationSettings.enablePayments}
                                    onCheckedChange={(checked) => setIntegrationSettings({...integrationSettings, enablePayments: checked})}
                                    className="ml-auto"
                                  />
                                </div>
                                
                                <div className="space-y-2">
                                  <Label htmlFor="paymentGateway" className="text-slate-300">
                                ...
                                {integrationSettings.paymentGateway === 'paypal' && (
                                  <div className="space-y-2">
                                    ...
                                    <Input
                                      ...
                                      onChange={(e) => setIntegrationSettings({...integrationSettings, paypalClientId: e.target.value})}
                                      className="bg-slate-700 border-slate-600 text-white"
                                      disabled={!integrationSettings.enablePayments}
                                    />
                                  </div>
                          ...
                          <CardFooter className="border-t border-slate-700 bg-slate-800/50 px-6 py-4">
                            <Button 
                              ...
                              disabled={updateSettings.isPending}
                            >
                              {updateSettings.isPending && updateSettings.variables?.integrations ? (
                                <>
                                  <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                                  {t('common.saving')}
                                </>
